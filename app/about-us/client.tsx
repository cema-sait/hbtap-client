...
function HeroSection() {
  return (
    <section className="bg-white ">
      ...
      <div className="container  mx-auto px-4 border-b-2 mt-12 py-6 ">
        <motion.div
          initial="hidden"
          animate="visible"
...
function AboutSection() {
  return (
    <section className="bg-white ">
      <div className="container mx-auto border-b border-gray-200 py-16">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="bg-gray-900 text-white px-4 py-2.5">
              <p className="text-base font-medium">Sustainable Finance Strategies for Healthcare</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <motion.h4 variants={itemVariants} className="text-base font-bold uppercase tracking-widest text-gray-900 mb-5">
              Our Main Objectives
            </motion.h4>
      ...
      <div className="container mx-auto px-4 sm:px-6 py-16">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p variants={itemVariants} className="text-xl leading-relaxed mb-5">
      ...
      <div className="container mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          ...
          >
            <motion.h3
              variants={itemVariants}
              className="text-base font-bold uppercase tracking-widest text-gray-900 mb-6"
            >
